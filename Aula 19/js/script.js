...
formulario.addEventListener("submit", (evento)=>{
   ...
   //Desativando o comportamento padrão do FORM 
   e.preventDefault();
   ...
   // Criando variavel de controle para validação
   let isValid = true;
   ...
   try{
      ...
      // Realizando uma desestruturação do objeto (Permite usar os objetos soltos)
      // DESTRUCTURIN
      ...
      if((nomeObj.length <= 3) || (nome == "") || (nomeObj == undefined)){
         
         //Função toggle e armazenando um erro

...
Siga as instruções abaixo utilizando **apenas HTML, CSS e JavaScript**.
...
- Aplicar **alguns estilos**
- Utilizar interatividade com **JavaScript**
...
- Adicione 3 parágrafos com descrições detalhadas sobre o do lugar.
- Adicione uma imagem.
---
